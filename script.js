    ...
    async placeOrder(customerName, items, note = '') {
        ...
        if (supabaseClient) {
            ...
            if (error) {
                ...
                this.alert("تم إرسال الطلب بنجاح", "success");
            }
        }
    ...
    function initTrackOrder() {
        ...
        trackSubmit.addEventListener('click', () => {
            ...
            if (order) {
                ...
                trackTime.innerText = new Date(order.created_at || order.timestamp).toLocaleString('ar-LY');
            ...
            if (recent.length === 0) {
                ...
                recent.forEach(o => {
                    ...
                    tr.innerHTML = `
                        ...
                        <td style="padding:0.8rem 0.5rem;">${new Date(o.created_at || o.timestamp).toLocaleDateString('ar-LY')}</td>
                        <td style="padding:0.8rem 0.5rem; color:#888;">${new Date(o.created_at || o.timestamp).toLocaleTimeString('ar-LY', { hour: '2-digit', minute: '2-digit' })}</td>
